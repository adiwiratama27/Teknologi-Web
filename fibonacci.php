            ...
            <div class="col-12 col-md-5">
                <form method="POST" action="#" class="bg-white form-container p-3" id="forminput">
                    ...
                    <div class="form-group" style="background-color:aqua">
                        ...
                        <input type="text" class="form-control" value="<?php echo $bilanganpertama; ?>" id="bilanganpertama"
                    ...
                    <div class="form-group" style="background-color:aqua">
                        ...
                        <h4 style="background-color:aqua; color: white;; text-align: center; border-radius: 4px;"><?php echo $deret; ?></h4>
                    </div>
                </form>
            </div>
        </div>
